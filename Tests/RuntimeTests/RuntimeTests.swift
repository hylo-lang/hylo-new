...
final class LayoutTests: XCTestCase {
  ...
  func testOffsetOfMember() throws {
    ...
    /*
    func p(checkCount: Int, recordLength: Int) {
      for _ in 0..<checkCount {
        let a = (0..<recordLength).map { _ in
    ...
    p(checkCount: 3, recordLength: 1)
    p(checkCount: 100, recordLength: 2)
    p(checkCount: 2000, recordLength: 10)
    */
