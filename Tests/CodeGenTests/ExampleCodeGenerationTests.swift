// Copied from SwiftyLLVM test suite. 
// 
// This should be deleted once we have other tests for code generation in place,
// this is just testing that our CI keeps working. 
