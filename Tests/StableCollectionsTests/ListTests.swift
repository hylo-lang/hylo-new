...
final class ListTests: XCTestCase {
  ...
  ///
  /// This covers the cases where either the moved or the target element sits on a corner
  /// (the first or last position) as well as the cases where both sit in the middle.
